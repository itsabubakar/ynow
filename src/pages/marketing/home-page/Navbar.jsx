...
const Navbar = () => {
  ...
  return (
    <nav className="relative z-10 flex items-center justify-center border-gray-300 bg-transparent">
      <div className="relative flex h-20 w-full max-w-[1440px] items-center justify-between gap-10 px-6 py-[18px] md:px-20">
        <NavLink to="/" className="relative">
          <RedLogo />
        </NavLink>

        {/* Desktop Navigation */}
        <div className="ml-auto hidden items-center justify-start gap-6 md:flex">
          <NavLink
            to="/"
            className={({ isActive }) =>
          ...
          <Popover className="group relative">
            <PopoverButton className="flex items-center text-base leading-normal font-semibold text-white outline-0">
              What We Do{" "}
              <ChevronDown
                color={"white"}
                className="ml-1 transition-transform duration-200 group-data-[open]:rotate-180"
              />
            </PopoverButton>
            <PopoverPanel
              anchor="top start"
